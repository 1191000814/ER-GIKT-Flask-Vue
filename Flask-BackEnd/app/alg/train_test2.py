...
split_point = math.ceil(data_len / batch_size * (params['k_fold'] - 1) / params['k_fold']) * batch_size
# 训练集和测试集的分割点, 目的是使训练集被batch_size整除
...
for epoch in range(params['epochs']):
    ...
    y_label[0][epoch], y_label[1][epoch], y_label[2][epoch] = test_loss, test_acc, test_auc
